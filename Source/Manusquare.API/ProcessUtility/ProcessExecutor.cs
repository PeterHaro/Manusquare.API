namespace Manusquare.API.ProcessUtility
{
    using System;
    ...
    public static partial class ProcessExecutor
    {
        ...
        public static async Task<ProcessResults> RunAsync(ProcessStartInfo processStartInfo, List<string> standardOutput, List<string> standardError,
